...
describe("ParserTT", () => {
  ...
  it("Rechaza un cuit incorrecto ", () => {
    ...
    expect(parserTT(msgCuitIncorrecto).errors).toContain(
      "CUIT no encontrado o formato incorrecto",
    );
  });
  ...
  it("Rechaza un tt sin cbu", () => {
    ...
    expect(parserTT(msgSinCbu).errors).toContain(
      "CBU no encontrado o formato incorrecto",
    );
  });
